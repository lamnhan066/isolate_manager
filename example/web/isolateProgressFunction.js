...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    IsolateContactorControllerImplFuture$(params, converter, onDispose, workerConverter, $R, $P) {
      ...
      t4 = t4 ? J.get$first$ax(params) : null;
      t3 = new A.IsolateContactorControllerImplFuture(t5, t1, t2, onDispose, converter, t4, t3, $R._eval$1("@<0>")._bind$1($P)._eval$1("IsolateContactorControllerImplFuture<1,2>"));
      t3.IsolateContactorControllerImplFuture$4$converter$onDispose$workerConverter(params, converter, onDispose, workerConverter, $R, $P);
      return t3;
    },
    ...
    IsolateContactorControllerImplWorker$(params, converter, onDispose, workerConverter, $R, $P) {
      ...
      t3 = t3 ? J.get$first$ax(params) : null;
      t2 = new A.IsolateContactorControllerImplWorker(t4, t1, onDispose, workerConverter, t3, t2, $R._eval$1("@<0>")._bind$1($P)._eval$1("IsolateContactorControllerImplWorker<1,2>"));
      t2.IsolateContactorControllerImplWorker$4$converter$onDispose$workerConverter(params, converter, onDispose, workerConverter, $R, $P);
      return t2;
    },
    IsolateContactorControllerImplWorker: function IsolateContactorControllerImplWorker(t0, t1, t2, t3, t4, t5, t6) {
      ...
      _._isolate_contactor_controller_web_worker$_initialParams = t4;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              controller.readLocal$1$0(t1).get$onIsolateMessage().listen$1(new A.IsolateManagerFunction_customFunction_closure(true, controller, true, onEvent, $P, $R));
    ...
    IsolateManagerFunction_customFunction_closure: function IsolateManagerFunction_customFunction_closure(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _.autoHandleResult = t0;
      _.controller = t1;
      _.autoHandleException = t2;
      _.onEvent = t3;
      _.P = t4;
      _.R = t5;
    },
    IsolateManagerFunction_customFunction__closure0: function IsolateManagerFunction_customFunction__closure0(t0, t1, t2, t3) {
      var _ = this;
      _.autoHandleResult = t0;
      _.controller = t1;
      _.R = t2;
    ...
    IsolateManagerFunction_customFunction__closure: function IsolateManagerFunction_customFunction__closure(t0, t1, t2) {
      this.controller = t0;
      this.R = t1;
      this.P = t2;
    },
    isolateProgressFunction(params) {
      var t1 = type$.String;
      A.IsolateManagerFunction_customFunction(params, new A.isolateProgressFunction_closure(), t1, t1);
    },
    isolateProgressFunction_closure: function isolateProgressFunction_closure() {
    },
    Recipe_isDigit(code) {
    ...
    main() {
      A.IsolateManagerFunction_customWorkerFunction(A.functions__isolateProgressFunction$closure());
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.IsolateManagerFunction_customFunction_closure.prototype = {
    call$1(message) {
      var err, stack, exception, _this = this,
        ...
        t3 = _this.R,
        t4 = _this.P,
        t5 = _this.autoHandleException,
        t6 = t5 ? new A.IsolateManagerFunction_customFunction__closure(t2, t3, t4) : null;
      t1.then$1$2$onError(new A.IsolateManagerFunction_customFunction__closure0(_this.autoHandleResult, t2, t3, t4), t6, type$.void);
      try {
        completer.complete$1(_this.onEvent.call$2(t2.readLocal$1$0(t3._eval$1("@<0>")._bind$1(t4)._eval$1("IsolateManagerController<1,2>")), message));
      } catch (exception) {
  ...
  A.IsolateManagerFunction_customFunction__closure0.prototype = {
    call$1(value) {
      var _this = this;
      return _this.autoHandleResult ? _this.controller.readLocal$1$0(_this.R._eval$1("@<0>")._bind$1(_this.P)._eval$1("IsolateManagerController<1,2>")).sendResult$1(value) : null;
    },
    $signature: 1
  };
  A.IsolateManagerFunction_customFunction__closure.prototype = {
    call$2(err, stack) {
      return this.controller.readLocal$1$0(this.R._eval$1("@<0>")._bind$1(this.P)._eval$1("IsolateManagerController<1,2>")).sendResultError$1(A.IsolateException$(err, stack));
    },
    $signature: 10
  };
  A.isolateProgressFunction_closure.prototype = {
    call$2(controller, message) {
      return this.$call$body$isolateProgressFunction_closure(controller, message);
    },
    $call$body$isolateProgressFunction_closure(controller, message) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, t1, t2, t3, i, progress;
      var $async$call$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = type$.String, t2 = type$.int, t3 = type$.dynamic, i = 0;
            case 3:
              // for condition
              if (!(i < 100)) {
                // goto after for
              ...
              progress = A.LinkedHashMap_LinkedHashMap$_literal(["progress", i], t1, t2);
              $async$goto = 6;
              return A._asyncAwait(A.Future_Future$delayed(B.Duration_100000, t3), $async$call$2);
            case 6:
              // returning from await.
              controller.sendResult$1(A.jsonEncode(progress));
            case 4:
              // for update
              ++i;
              // goto for condition
            ...
            case 5:
              // after for
              $async$returnValue = A.jsonEncode(A.LinkedHashMap_LinkedHashMap$_literal(["result", message], t1, t1));
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 22, 0);
    ...
    _static_1(A, "utils__convertNested$closure", "convertNested", 3);
    _static_1(A, "utils__jsify$closure", "jsify", 6);
    _static_1(A, "functions__isolateProgressFunction$closure", "isolateProgressFunction", 1);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "Null()", "@(@)", "~(Object,StackTrace)", "~(Object?,Object?)", "Object?(Object?)", "~(~())", "Null(@)", "Null(JSObject)", "~(@,@)", "Future<Null>()", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(IsolatePort,@)", "MapEntry<@,Object?>(@,@)", "Future<String>(IsolateManagerController<String,String>,String)", "~(Zone?,ZoneDelegate?,Zone,~())"],
