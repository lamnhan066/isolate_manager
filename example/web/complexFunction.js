...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    ComplexModelParam$(age, hobbies, $name) {
      return new A.ComplexModelParam($name, age, hobbies);
    },
    ComplexModelParam_ComplexModelParam$fromJson(json) {
      return A.ComplexModelParam_ComplexModelParam$fromMap(A.jsonDecode(json));
    },
    ComplexModelParam_ComplexModelParam$fromMap(json) {
      var t1 = json.$index(0, "name");
      return A.ComplexModelParam$(json.$index(0, "age"), A.List_List$from(json.$index(0, "hobbies"), type$.String), t1);
    },
    ComplexModelResult$(messages) {
      return new A.ComplexModelResult(messages);
    },
    ComplexModelParam: function ComplexModelParam(t0, t1, t2) {
      this.name = t0;
      this.age = t1;
      this.hobbies = t2;
    },
    ComplexModelResult: function ComplexModelResult(t0) {
      this.messages = t0;
    },
    ...
    main() {
      var t1 = type$.String;
      A.IsolateManagerFunction_workerFunction(A.functions__complexFunction$closure(), t1, t1);
    },
    complexFunction(param) {
      var t1, t2, t3, t4,
        parsed = A.ComplexModelParam_ComplexModelParam$fromJson(param),
        result = A._setArrayType([], type$.JSArray_String);
      for (t1 = J.get$iterator$ax(parsed.hobbies), t2 = parsed.name, t3 = parsed.age; t1.moveNext$0();) {
        t4 = t1.get$current();
        result.push("My name is " + A.S(t2) + ", I'm " + A.S(t3) + " years old, My hobby is " + t4);
      }
      return A.ComplexModelResult$(result).toJson$0();
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.ComplexModelParam.prototype = {
    toJson$0() {
      return A.jsonEncode(this.toMap$0());
    },
    toMap$0() {
      return A.LinkedHashMap_LinkedHashMap$_literal(["name", this.name, "age", this.age, "hobbies", this.hobbies], type$.String, type$.dynamic);
    }
  };
  A.ComplexModelResult.prototype = {
    toMap$0() {
      return A.LinkedHashMap_LinkedHashMap$_literal(["messages", this.messages], type$.String, type$.dynamic);
    },
    toJson$0() {
      return B.C_JsonCodec.encode$1(this.toMap$0());
    }
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 21, 0);
    ...
    _static_1(A, "utils__convertNested$closure", "convertNested", 2);
    _static_1(A, "utils__jsify$closure", "jsify", 6);
    _static_1(A, "functions__complexFunction$closure", "complexFunction", 22);
  })();
