...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      A.IsolateManagerFunction_workerFunction(A.functions__testMap$closure(), t1, t1);
    },
    testMap(map) {
      return map;
    }
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "functions__testMap$closure", "testMap", 22);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "Null()", "~(Object,StackTrace)", "Object?(Object?)", "~(~())", "@(@)", "Null(@)", "Null(JSObject)", "~(@,@)", "Future<Null>()", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?,Object?)", "~(IsolatePort,@)", "MapEntry<@,Object?>(@,@)", "~(Zone?,ZoneDelegate?,Zone,~())", "Map<@,@>(Map<@,@>)"],
