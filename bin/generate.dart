...
///   5: File not found
///
///   11: Could not find package `isolate_manager_generator` or file
...
void main(List<String> args) async {
  ...
  if (!isGeneratorInstalled) {
    if (args.contains('--add-generator')) {
      ...
      print(
        'Missing dependency: `isolate_manager_generator`.\n'
        'To fix this, you have two options:\n'
        '1. Run: `dart pub add isolate_manager_generator --dev`\n'
...
bool _isGeneratorInstalled() {
  ...
  return output.contains('isolate_manager_generator');
}
