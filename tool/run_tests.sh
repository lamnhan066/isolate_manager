...
dart run isolate_manager:generate --add-generator -i test -o test/workers --single --sub-dir workers --worker-mappings-experiment=test/isolate_manager_test.dart --obfuscate 0 -- --omit-implicit-checks
dart run isolate_manager:generate --add-generator -i test -o test/workers --shared --sub-dir workers --worker-mappings-experiment=test/isolate_manager_shared_test.dart --obfuscate 0 -- --omit-implicit-checks
