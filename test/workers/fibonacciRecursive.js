...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = type$.int;
      A.IsolateManagerFunction_workerFunction(A.functions__fibonacciRecursive$closure(), t1, t1);
    },
    fibonacciRecursive(n) {
      ...
      if (n === 1)
        return 1;
      t1 = A.fibonacciRecursive(n - 1);
      t2 = A.fibonacciRecursive(n - 2);
      if (typeof t1 !== "number")
        return t1.$add();
      if (typeof t2 !== "number")
        return A.iae(t2);
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "functions__fibonacciRecursive$closure", "fibonacciRecursive", 28);
  })();
