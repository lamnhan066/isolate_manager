...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    isolateCallbackSimpleFunction(params) {
      A.IsolateManagerFunction_customFunction(params, new A.isolateCallbackSimpleFunction_closure(), type$.String, type$.nullable_Object);
    },
    isolateCallbackSimpleFunction_closure: function isolateCallbackSimpleFunction_closure() {
    },
    Recipe_isDigit(code) {
    ...
    main() {
      A.IsolateManagerFunction_customWorkerFunction(A.functions__isolateCallbackSimpleFunction$closure());
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.isolateCallbackSimpleFunction_closure.prototype = {
    call$2(controller, message) {
      ...
      return A.jsonEncode(A.LinkedHashMap_LinkedHashMap$_literal(["data", message], t1, type$.nullable_Object));
    },
    $signature: 24
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "functions__isolateCallbackSimpleFunction$closure", "isolateCallbackSimpleFunction", 1);
