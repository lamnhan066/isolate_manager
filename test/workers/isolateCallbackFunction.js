...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    IsolateContactorControllerImplFuture$(params, converter, debugMode, onDispose, $R, $P) {
      var t1 = A.Completer_Completer(type$.void),
        ...
        t3 = type$.List_dynamic._is(params) ? J.get$first$ax(params) : null;
      t1 = new A.IsolateContactorControllerImplFuture(t2, A.StreamController_StreamController$broadcast($R), A.StreamController_StreamController$broadcast($P), onDispose, converter, t3, debugMode, t1, $R._eval$1("@<0>")._bind$1($P)._eval$1("IsolateContactorControllerImplFuture<1,2>"));
    ...
    IsolateContactorControllerImplFuture: function IsolateContactorControllerImplFuture(t0, t1, t2, t3, t4, t5, t6, t7, t8) {
      var _ = this;
      ...
      _._isolate_contactor_controller_web$_debugMode = t6;
      _.ensureInitialized = t7;
      _.$ti = t8;
    },
    ...
    IsolateContactorControllerImplWorker$(params, debugMode, onDispose, workerConverter, $R, $P) {
      ...
      t2 = t2 ? J.get$first$ax(params) : null;
      t1 = new A.IsolateContactorControllerImplWorker(t3, onDispose, workerConverter, t2, A.StreamController_StreamController$broadcast($R), debugMode, t1, $R._eval$1("@<0>")._bind$1($P)._eval$1("IsolateContactorControllerImplWorker<1,2>"));
    ...
    IsolateContactorControllerImplWorker: function IsolateContactorControllerImplWorker(t0, t1, t2, t3, t4, t5, t6, t7) {
      var _ = this;
      _._isolate_contactor_controller_web_worker$_delegate = t0;
      _._onDispose = t1;
      _._workerConverter = t2;
      _._isolate_contactor_controller_web_worker$_initialParams = t3;
      _._mainStreamController = t4;
      _._debugMode = t5;
    ...
    IsolateManagerFunction_customFunction(params, autoHandleException, autoHandleResult, onEvent, $R, $P) {
      return A.IsolateManagerFunction_customFunction$body(params, autoHandleException, autoHandleResult, onEvent, $R, $P);
    },
    IsolateManagerFunction_customFunction$body(params, autoHandleException, autoHandleResult, onEvent, $R, $P) {
      var $async$goto = 0,
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              controller.readLocal$1$0(t1).get$onIsolateMessage().listen$1(new A.IsolateManagerFunction_customFunction_closure(onEvent, controller, autoHandleResult, autoHandleException, $P, $R));
    ...
    isolateCallbackFunction(params) {
      A.IsolateManagerFunction_customFunction(params, false, false, new A.isolateCallbackFunction_closure(), type$.String, type$.nullable_Object);
    },
    isolateCallbackFunction_closure: function isolateCallbackFunction_closure() {
    },
    Recipe_isDigit(code) {
    ...
    main() {
      A.IsolateManagerFunction_customWorkerFunction(A.functions__isolateCallbackFunction$closure());
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.IsolateManagerFunction_customFunction_closure.prototype = {
    ...
    $call$body$IsolateManagerFunction_customFunction_closure(message) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$currentError, $async$self = this, value, err, stack, t1, t2, t3, exception, $async$exception;
  ...
  A.isolateCallbackFunction_closure.prototype = {
    call$2(controller, message) {
      var i, err, stack, t1, t2, exception;
      try {
        i = 0;
        t1 = type$.String;
        while (true) {
          ...
          if (!(t2 < 10))
            break;
          controller.sendResult$1(A.jsonEncode(A.LinkedHashMap_LinkedHashMap$_literal(["source", A.S(i)], t1, t1)));
          t2 = i;
          if (typeof t2 !== "number")
            return t2.$add();
          i = t2 + 1;
        }
        controller.sendResult$1(A.jsonEncode(A.LinkedHashMap_LinkedHashMap$_literal(["data", "data"], t1, t1)));
      } catch (exception) {
        err = A.unwrapException(exception);
        stack = A.getTraceFromException(exception);
        controller.sendResultError$1(A.IsolateException$(err, stack, ""));
      }
      return "";
    },
    $signature: 24
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(A.CastStreamSubscription.prototype, "get$_onData", "_onData$1", 10);
    ...
    _static_1(A, "functions__isolateCallbackFunction$closure", "isolateCallbackFunction", 1);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "Null()", "~(Object,StackTrace)", "~(Object?,Object?)", "String()", "~(~())", "@(@)", "Null(@)", "Object?(Object?)", "~(Object?)", "Future<~>()", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "Future<~>(@)", "~(JSObject)", "Null(JSObject)", "ImType<Object>(@)", "MapEntry<ImType<Object>,ImType<Object>>(@,@)", "String(IsolateManagerController<Object?,Object?>,Object?)", "~(Zone?,ZoneDelegate?,Zone,~())", "IsolateException(Object[StackTrace,String])", "UnsupportedImTypeException(Object[StackTrace])", "0^(@{customConverter:0^(@)?,enableWasmConverter:bool})<Object?>"],
