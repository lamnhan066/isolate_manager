...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = type$.ImList;
      A.IsolateManagerFunction_workerFunction(A.functions__isolateTypeList$closure(), t1, t1);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "functions__isolateTypeList$closure", "isolateTypeList", 28);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null()", "~(@)", "~(Object,StackTrace)", "String()", "~(~())", "Null(@)", "Object?(Object?)", "~(Object?)", "Future<~>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?,Object?)", "Future<~>(@)", "~(JSObject)", "Null(JSObject)", "ImType<Object>(@)", "MapEntry<ImType<Object>,ImType<Object>>(@,@)", "ImString(Object)", "~(Zone?,ZoneDelegate?,Zone,~())", "IsolateException(Object[StackTrace,String])", "UnsupportedImTypeException(Object[StackTrace])", "ImList(ImList)", "0^(@{customConverter:0^(@)?,enableWasmConverter:bool})<Object?>"],
