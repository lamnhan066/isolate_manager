...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      A.IsolateManagerFunction_workerFunction(A.functions__isolateTypeMap$closure(), type$.ImMap, type$.ImList);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "functions__isolateTypeMap$closure", "isolateTypeMap", 28);
