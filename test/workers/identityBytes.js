// Generated by dart2js (, omit checks, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.10.0.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _UnmodifiableNativeByteBufferView$(_data) {
      return new A._UnmodifiableNativeByteBufferView();
    },
    ...
    _UnmodifiableNativeByteBufferView: function _UnmodifiableNativeByteBufferView() {
    },
    ...
    ByteBufferToJSArrayBuffer_get_toJS(_this) {
      return type$.NativeArrayBuffer._as(_this);
    },
    ...
    IsolateContactorControllerImplWorker$(params, debugMode, onDispose, workerConverter, $R, $P) {
      var t1 = A.Completer_Completer(type$.void),
        ...
        t3 = t2 ? A._asJSObject(type$.IsolateContactorControllerImpl_dynamic_dynamic._as(J.get$last$ax(params)).get$controller()) : A._asJSObject(params);
      if (t2)
        J.get$first$ax(params);
    ...
    IsolateManagerControllerImpl$(params, onDispose, $R, $P) {
      var t1 = J.$eq$(J.get$runtimeType$(params), B.Type_JSObject_ttY) ? A._IsolateManagerWorkerController$(A._asJSObject(params), onDispose, $R, $P) : A.IsolateContactorController_IsolateContactorController(params, onDispose, $R, $P);
    ...
    extractArrayBuffers(transferables) {
      ...
      for (t1 = J.get$iterator$ax(transferables), t2 = type$.Uint8List, t3 = type$.ByteBuffer; t1.moveNext$0();) {
        t4 = t1.get$current();
        if (t3._is(t4))
          buffers.push(A.ByteBufferToJSArrayBuffer_get_toJS(t4));
        else if (t2._is(t4))
          buffers.push(A.ByteBufferToJSArrayBuffer_get_toJS(B.NativeUint8List_methods.get$buffer(t4)));
      }
      return A.ListToJSArray_get_toJS(buffers, type$.NativeArrayBuffer);
    },
    debugPrinter(log, debug) {
    },
    main() {
      var t1 = type$.Uint8List;
      A.IsolateManagerFunction_workerFunction(A.transfer_performance_test__identityBytes$closure(), t1, t1);
    },
    identityBytes(data) {
      return data;
    }
  ...
  A.CastStreamSubscription.prototype = {
    ...
    _onData$1(data) {
      var targetData, error, stack, handleError, exception, t2, _this = this,
  ...
  A.IsolateContactorControllerImplFuture.prototype = {
    ...
    sendResult$2$transferables(message, transferables) {
      ...
      if (t1.get$isClosed())
        return;
      t1.get$sink().add$1(0, A.LinkedHashMap_LinkedHashMap$_literal([B.IsolatePort_0, message], type$.IsolatePort, this.$ti._precomputed1));
    },
    sendResultError$1(exception) {
      var t1 = this._isolate_contactor_controller_web$_delegate;
      if (t1.get$isClosed())
        return;
      t1.get$sink().add$1(0, A.LinkedHashMap_LinkedHashMap$_literal([B.IsolatePort_0, exception], type$.IsolatePort, type$.IsolateException));
    },
    close$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
    ...
    _handleMainPort$1(value) {
      ...
      $label0$0: {
        ...
        try {
          ...
          _this._isolate_contactor_controller_web$_mainStreamController.add$1(0, t1);
        } catch (exception) {
          e = A.unwrapException(exception);
          stack = A.getTraceFromException(exception);
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 4:
              // join
              try {
                $async$self._isolateStreamController.add$1(0, $async$self.$ti._rest[1]._as(value));
              } catch (exception) {
                e = A.unwrapException(exception);
                stack = A.getTraceFromException(exception);
  ...
  A.IsolateManagerController.prototype = {
    ...
    sendResult$1(result) {
      return this._delegate.sendResult$2$transferables(result, null);
    },
    sendResultError$1(exception) {
  ...
  A.IsolateManagerControllerImpl.prototype = {
    ...
    sendResult$2$transferables(result, transferables) {
      return this._web$_delegate.sendResult$2$transferables(result, transferables);
    },
    sendResult$1(result) {
      return this.sendResult$2$transferables(result, null);
    },
    sendResultError$1(exception) {
      return this._web$_delegate.sendResultError$1(exception);
    },
    $isIsolateManagerController: 1,
    $isInitialParamsMixin: 1
  };
  A._IsolateManagerWorkerController.prototype = {
    ...
    get$onIsolateMessage() {
      return this._streamController.get$stream().cast$1$0(0, this.$ti._rest[1]);
    },
    sendResult$2$transferables(m, transferables) {
      var _s11_ = "postMessage",
        payload = A.NullableObjectUtilExtension_jsify(A.LinkedHashMap_LinkedHashMap$_literal(["type", "data", "value", m instanceof A.ImType ? m.get$unwrap() : m], type$.String, type$.nullable_Object)),
        t1 = transferables != null && J.get$isNotEmpty$ax(transferables),
        t2 = type$.void,
        t3 = this.self;
      if (t1)
        A._callMethodUnchecked2(t3, _s11_, payload, A.extractArrayBuffers(transferables), t2);
      else
        A._callMethodUnchecked1(t3, _s11_, payload, t2);
    },
    sendResultError$1(exception) {
  ...
  A._IsolateManagerWorkerController_closure.prototype = {
    call$1($event) {
      ...
      if (A.isImTypeSubtype(t1)) {
        t2 = result == null ? A._asObject(result) : result;
        result = A.ImType_wrap(t2, type$.ImType_Object);
      }
      this.$this._streamController.get$sink().add$1(0, t1._as(result));
    },
    $signature: 20
  };
  ...
  A.IsolateException.prototype = {
    toMap$0() {
      var t1 = type$.String;
      return A.LinkedHashMap_LinkedHashMap$_literal(["type", "$IsolateException", "name", this.get$name(), "value", A.LinkedHashMap_LinkedHashMap$_literal(["e", J.toString$0$(this.error), "s", this.stackTrace.toString$0(0)], t1, t1)], t1, type$.dynamic);
    },
    toString$0(_) {
  ...
  A.ImList.prototype = {
    $eq(_, other) {
      ...
      if (other == null)
        return false;
      if (this !== other)
        t1 = other instanceof A.ImList && this.get$runtimeType(0) === other.get$runtimeType(0) && this._listEquals$1(other._list);
      else
        t1 = true;
      return t1;
    },
  ...
  A._ImTypedMap.prototype = {
    ...
    $eq(_, other) {
      ...
      if (other == null)
        return false;
      if (this !== other)
        t1 = other instanceof A.ImMap && this.get$runtimeType(0) === other.get$runtimeType(0) && this._mapEquals$1(other._isolate_types$_map);
      else
        t1 = true;
      return t1;
    },
    ...
    _mapEquals$1(otherMap) {
      ...
      if (t1.get$length(t1) !== otherMap.get$length(otherMap))
        return false;
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "transfer_performance_test__identityBytes$closure", "identityBytes", 27);
  })();
  (function inheritance() {
    ...
    _mixinHard(A._IsolateManagerControllerImpl_Object_InitialParamsMixin, A.InitialParamsMixin);
  })();
  var init = {
