...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      A.IsolateManagerFunction_workerFunction(A.web_transfer_test__processBytes$closure(), t1, t1);
    },
    processBytes(data) {
      var t2, i, t3,
        t1 = data.length,
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "web_transfer_test__processBytes$closure", "processBytes", 27);
  })();
