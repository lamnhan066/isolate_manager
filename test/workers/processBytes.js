// Generated by dart2js (, omit checks, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.11.0.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    isToStringVisiting(object) {
      var t2,
        ...
        t1 = J.getInterceptor$asx(visiting),
        i = 0;
      for (;;) {
        t2 = t1.get$length(visiting);
        if (typeof t2 !== "number")
          return A.iae(t2);
        if (!(i < t2))
          break;
        if (object === t1.$index(visiting, i))
          return true;
        ++i;
      }
      return false;
    ...
    IsolateContactorControllerImplFuture_sendResult_closure: function IsolateContactorControllerImplFuture_sendResult_closure() {
    },
    ...
    IsolateContactorControllerImplWorker: function IsolateContactorControllerImplWorker(t0, t1, t2, t3, t4, t5, t6) {
      ...
      _._isolate_contactor_controller_web_worker$_debugMode = t4;
    ...
    extractArrayBuffers(transferables) {
      ...
      for (t1 = J.get$iterator$ax(transferables), t2 = type$.Uint8List, t3 = type$.ByteBuffer, t4 = type$.NativeArrayBuffer; t1.moveNext$0();) {
        ...
        if (t4._is(t5))
          ...
          buffers.push(A.ByteBufferToJSArrayBuffer_get_toJS(t5));
        else if (t2._is(t5))
          buffers.push(A.ByteBufferToJSArrayBuffer_get_toJS(B.NativeUint8List_methods.get$buffer(t5)));
      }
      return A.ListToJSArray_get_toJS(buffers, t4);
    },
    debugPrinter(log, debug) {
    },
    main() {
      var t1 = type$.Uint8List;
      A.IsolateManagerFunction_workerFunction(A.functions__processBytes$closure(), t1, t1);
    },
    processBytes(data) {
      var t2, i, t3,
        t1 = data.length,
  ...
  A.IsolateContactorControllerImplFuture.prototype = {
    ...
    sendResult$2$transferables(message, transferables) {
      ...
      if (t1.get$isClosed())
        return;
      if (transferables != null && J.get$isNotEmpty$ax(transferables))
        A.debugPrinter(new A.IsolateContactorControllerImplFuture_sendResult_closure(), this._debugMode);
    ...
    _handleMainPort$1(value) {
      ...
      A.debugPrinter(new A.IsolateContactorControllerImplFuture__handleMainPort_closure(value), _this._debugMode);
      $label0$0: {
      ...
      var $async$_handleIsolatePort$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              A.debugPrinter(new A.IsolateContactorControllerImplFuture__handleIsolatePort_closure(value), $async$self._debugMode);
  ...
  A.IsolateContactorControllerImplFuture_sendResult_closure.prototype = {
    call$0() {
      return "[Isolate] transferables ignored in Web Future mode. Set workerName to use Worker transfer lists.";
    },
    $signature: 3
  };
  ...
  A.IsolateContactorControllerImplWorker.prototype = {
    ...
    _handleMessage$1($event) {
      ...
      A.debugPrinter(new A.IsolateContactorControllerImplWorker__handleMessage_closure($event), _this._isolate_contactor_controller_web_worker$_debugMode);
      try {
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "functions__processBytes$closure", "processBytes", 27);
  })();
