...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = type$.ImNum;
      A.IsolateManagerFunction_workerFunction(A.functions__throwsIsolateException$closure(), t1, t1);
    },
    throwsIsolateException(number) {
      throw A.wrapException(B.IsolateException_4CA);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "functions__throwsIsolateException$closure", "throwsIsolateException", 28);
  })();
...
;
    ...
    B.IsolateException_4CA = new A.IsolateException("", "IsolateException", B._StringStackTrace_uwd);
