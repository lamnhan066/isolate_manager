...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    isolateCallbackSimpleFunctionWithSpecifiedType(params) {
      A.IsolateManagerFunction_customFunction(params, new A.isolateCallbackSimpleFunctionWithSpecifiedType_closure(), type$.String, type$.int);
    },
    isolateCallbackSimpleFunctionWithSpecifiedType_closure: function isolateCallbackSimpleFunctionWithSpecifiedType_closure() {
    },
    Recipe_isDigit(code) {
    ...
    main() {
      A.IsolateManagerFunction_customWorkerFunction(A.functions__isolateCallbackSimpleFunctionWithSpecifiedType$closure());
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.isolateCallbackSimpleFunctionWithSpecifiedType_closure.prototype = {
    call$2(controller, message) {
      var t1, i;
      for (t1 = type$.String, i = 0; i < 10; ++i)
        controller.sendResult$1(A.jsonEncode(A.LinkedHashMap_LinkedHashMap$_literal(["source", "" + i], t1, t1)));
      return A.jsonEncode(A.LinkedHashMap_LinkedHashMap$_literal(["data", message], t1, type$.int));
    },
    $signature: 24
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "functions__isolateCallbackSimpleFunctionWithSpecifiedType$closure", "isolateCallbackSimpleFunctionWithSpecifiedType", 1);
