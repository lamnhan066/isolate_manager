...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    a2DTo1DList(params) {
      return J.toList$0$ax(J.map$1$1$ax(params, new A.a2DTo1DList_closure(), type$.String));
    },
    a2DTo1DList_closure: function a2DTo1DList_closure() {
    },
    ...
    main() {
      ...
      A.IsolateManagerFunction_workerFunction(A.functions__a2DTo1DList$closure(), t1, t1);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.a2DTo1DList_closure.prototype = {
    call$1(e) {
      return J.join$0$ax(type$.List_dynamic._as(e));
    },
    $signature: 24
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "functions__a2DTo1DList$closure", "a2DTo1DList", 28);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null()", "~(@)", "~(Object,StackTrace)", "String()", "~(~())", "Null(@)", "Object?(Object?)", "~(Object?)", "Future<~>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?,Object?)", "Future<~>(@)", "~(JSObject)", "Null(JSObject)", "ImType<Object>(@)", "MapEntry<ImType<Object>,ImType<Object>>(@,@)", "String(@)", "~(Zone?,ZoneDelegate?,Zone,~())", "IsolateException(Object[StackTrace,String])", "UnsupportedImTypeException(Object[StackTrace])", "List<@>(List<@>)", "0^(@{customConverter:0^(@)?,enableWasmConverter:bool})<Object?>"],
