...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = type$.ImMap;
      A.IsolateManagerFunction_workerFunction(A.functions__isolateTypeMapToMap$closure(), t1, t1);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "functions__isolateTypeMapToMap$closure", "isolateTypeMapToMap", 28);
