...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    ImType_wrap(object, $R) {
      ...
      $label0$0: {
        ...
        t1 = A.throwExpression(A.UnimplementedError$("Unsupported type " + A.S(J.get$runtimeType$(object)) + " when wrapping an IsolateType"));
      }
      return $R._as(t1);
    },
    ImNum$(value) {
    ...
    isolateTypeMapToMap(numbers) {
      var t1 = type$.ImType_Object;
      return A.ImMap$(numbers.toMap$2$0(t1, t1).map$2$1(0, new A.isolateTypeMapToMap_closure(), t1, t1));
    },
    isolateTypeMapToMap_closure: function isolateTypeMapToMap_closure() {
    },
    ...
    main() {
      var t1 = type$.ImMap;
      A.IsolateManagerFunction_workerFunction(A.isolate_manager_test__isolateTypeMapToMap$closure(), t1, t1);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.CastMap.prototype = {
    ...
    forEach$1(_, f) {
      J.forEach$1$z(this._source, new A.CastMap_forEach_closure(this, f));
    },
    get$keys() {
      var t1 = this.$ti;
  ...
  A.IsolateContactorControllerImplFuture.prototype = {
    ...
    _handleMainPort$1(value) {
      ...
      $label0$0: {
        ...
        e0 = t1 ? value : null;
        if (t1) {
          _this._isolate_contactor_controller_web$_mainStreamController.addError$2(e0.error, e0.stack);
          break $label0$0;
        }
        try {
          t1 = _this._converter;
  ...
  A.IsolateContactorControllerImplWorker.prototype = {
    ...
    _handleMessage$1($event) {
      var data, result, e, stack, t1, exception, _this = this;
      ...
      try {
        ...
        if (A.IsolateException_isValidMap(data)) {
          _this._mainStreamController.addError$1(data);
          return;
        }
        _this._mainStreamController.addError$1(A.IsolateException$("Unhandled " + A.S(data) + " from the Isolate", B.C__StringStackTrace).toMap$0());
      } catch (exception) {
        e = A.unwrapException(exception);
        stack = A.getTraceFromException(exception);
        _this._mainStreamController.addError$1(A.IsolateException$(e, stack).toMap$0());
      }
    },
    $isIsolateContactorController: 1,
    $isIsolateContactorControllerImpl: 1,
  ...
  A.isolateWorkerImpl_closure.prototype = {
    ...
    $call$body$isolateWorkerImpl_closure(message) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$currentError, $async$self = this, result, err, stack, exception, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$self.controller.sendResultError$1(A.IsolateException$(err, stack));
              // goto after finally
              $async$goto = 5;
              break;
            case 2:
  ...
  A.ImMap.prototype = {
    toMap$2$0($K, $V) {
      return J.cast$2$0$ax(this._map, $K, $V);
    },
    toString$0(_) {
      return "ImMap(" + A.S(this._map) + ")";
    }
  };
  ...
  A._ImTypedMap.prototype = {
    get$unwrap() {
      var t1 = A._instanceType(this);
      return J.map$2$1$ax(this._map, new A._ImTypedMap_unwrap_closure(this), t1._eval$1("_ImTypedMap.K"), t1._eval$1("_ImTypedMap.V"));
    },
    $eq(_, other) {
      var t1;
      if (other == null)
        return false;
      if (this !== other)
        t1 = other instanceof A.ImMap && J.$eq$(this.get$runtimeType(0), other.get$runtimeType(0)) && this._mapEquals$1(other._map);
      else
        t1 = true;
      return t1;
    },
    get$hashCode(_) {
      return A.Object_hashAll(this._map.get$entries());
    },
  ...
  A.isolateTypeMapToMap_closure.prototype = {
    call$2(k, v) {
      var t1 = type$.ImType_Object;
      return A.MapEntry$_(A.ImString$(A.S(k.get$unwrap())), v, t1, t1);
    },
    $signature: 24
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 25, 0);
    ...
    _static_1(A, "isolate_manager_test__isolateTypeMapToMap$closure", "isolateTypeMapToMap", 26);
