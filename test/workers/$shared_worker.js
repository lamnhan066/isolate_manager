...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    workerFunctionImpl(map) {
      A.IsolateManagerFunction_workerFunction(new A.workerFunctionImpl_closure(map), type$.dynamic, type$.List_dynamic);
    },
    ...
    isolateTypeNum(number) {
      return A.ImNum$(number.get$unwrap());
    },
    isolateTypeString(string) {
      return A.ImString$(string.get$unwrap());
    },
    isolateTypeBool(boolean) {
      return A.ImBool$(boolean.get$unwrap());
    },
    isolateTypeList(numbers) {
      return A.ImList$(J.toList$0$ax(J.map$1$1$ax(numbers.get$unwrap(), new A.isolateTypeList_closure(), type$.ImString)));
    },
    isolateTypeMap(numbers) {
      var t1 = type$.ImType_Object;
      return A.ImMap$(A.Map_Map$fromEntries(J.map$1$1$ax(numbers.get$unwrap(), new A.isolateTypeMap_closure(), type$.MapEntry_of_ImType_Object_and_ImType_Object), t1, t1));
    },
    isolateNullableInt(number) {
      return number;
    },
    addFuture(values) {
      return A.addFuture$body(values);
    },
    addFuture$body(values) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.double),
        $async$returnValue, t1;
      var $async$addFuture = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = J.getInterceptor$ax(values);
              $async$returnValue = t1.$index(values, 0) + t1.$index(values, 1);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$addFuture, $async$completer);
    },
    add(values) {
      var t1 = J.getInterceptor$ax(values);
      return t1.$index(values, 0) + t1.$index(values, 1);
    },
    addException(values) {
      return A.throwExpression(A.Exception_Exception("Has Exception"));
    },
    concat(params) {
      var t1 = J.getInterceptor$ax(params);
      return t1.$index(params, 0) + " " + t1.$index(params, 1);
    },
    complexReturn(params) {
      return params;
    },
    isolateTypeList_closure: function isolateTypeList_closure() {
    },
    isolateTypeMap_closure: function isolateTypeMap_closure() {
    },
    ...
    internalFunction$body(params) {
      var $async$goto = 0,
        ...
        $async$returnValue, completer, t1, t2, t3, parameter;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = type$.dynamic;
              t2 = A._asBoolQ(A.IterableExtensions_elementAtOrNull(params, 2, t1));
              t3 = J.getInterceptor$ax(params);
              parameter = t3.$index(params, 1);
              if (t2 === true) {
                t2 = parameter == null ? type$.Object._as(parameter) : parameter;
                parameter = A.ImType_wrap(t2, type$.ImType_Object);
              }
              completer = A.Completer_Completer(t1);
              completer.complete$1(type$.Function._as(t3.$index(params, 0)).call$1(parameter));
    ...
    main() {
      A.IsolateManagerFunction_sharedWorkerFunction($.$get$map());
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.workerFunctionImpl_closure.prototype = {
    call$1(message) {
      var t1 = J.getInterceptor$ax(message);
      return A.internalFunction([J.$index$ax(this.map, t1.$index(message, 0)), t1.$index(message, 1), t1.$index(message, 2)]);
    },
    $signature: 20
  };
  ...
  A.isolateTypeList_closure.prototype = {
    call$1(e) {
      return A.ImString$(A.S(e));
    },
    $signature: 24
  };
  A.isolateTypeMap_closure.prototype = {
    call$1(e) {
      var t1 = type$.ImType_Object;
      return A.MapEntry$_(A.ImString$(A.S(e)), A.ImNum$(A._asNum(e)), t1, t1);
    },
    $signature: 25
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(A.CastStreamSubscription.prototype, "get$_onData", "_onData$1", 14);
    ...
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 27, 0);
    ...
    _instance_1_u(A.IsolateContactorControllerImplFuture.prototype, "get$_handleEvent", "_handleEvent$1", 17);
    _instance_1_u(A.IsolateContactorControllerImplWorker.prototype, "get$_handleMessage", "_handleMessage$1", 19);
    ...
    _static_1(A, "functions__aDynamicMap$closure", "aDynamicMap", 30);
    _static_1(A, "functions__isolateTypeNum$closure", "isolateTypeNum", 31);
    _static_1(A, "functions__isolateTypeString$closure", "isolateTypeString", 32);
    _static_1(A, "functions__isolateTypeBool$closure", "isolateTypeBool", 33);
    _static_1(A, "functions__isolateTypeList$closure", "isolateTypeList", 34);
    _static_1(A, "functions__isolateTypeMap$closure", "isolateTypeMap", 35);
    _static_1(A, "functions__isolateNullableInt$closure", "isolateNullableInt", 36);
    _static_1(A, "functions__addFuture$closure", "addFuture", 37);
    _static_1(A, "functions__add$closure", "add", 38);
    _static_1(A, "functions__addException$closure", "addException", 39);
    _static_1(A, "functions__concat$closure", "concat", 40);
    _static_1(A, "functions__complexReturn$closure", "complexReturn", 41);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null()", "~(@)", "~(~())", "~(Object,StackTrace)", "String()", "Null(@)", "Object?(Object?)", "_Future<@>(@)", "@(String)", "Null(@,StackTrace)", "~(int,@)", "Future<~>()", "Null(Object,StackTrace)", "~(Object?)", "~(Object?,Object?)", "Null(~())", "Future<~>(@)", "@(@)", "~(JSObject)", "Future<@>(List<@>)", "Null(JSObject)", "ImType<Object>(@)", "MapEntry<ImType<Object>,ImType<Object>>(@,@)", "ImString(Object)", "MapEntry<ImType<Object>,ImType<Object>>(Object)", "@(@,String)", "~(Zone?,ZoneDelegate?,Zone,~())", "0^(@{customConverter:0^(@)?,enableWasmConverter:bool})<Object?>", "UnsupportedImTypeException(Object[StackTrace])", "Map<@,@>(Map<@,@>)", "ImNum(ImNum)", "ImString(ImString)", "ImBool(ImBool)", "ImList(ImList)", "ImMap(ImList)", "int?(int?)", "Future<double>(List<double>)", "int(List<int>)", "int(@)", "String(List<String>)", "List<List<String>>(List<List<String>>)", "IsolateException(Object[StackTrace,String])"],
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "map", "$get$map", () => A.LinkedHashMap_LinkedHashMap$_literal(["aDynamicMap", A.functions__aDynamicMap$closure(), "isolateTypeNum", A.functions__isolateTypeNum$closure(), "isolateTypeString", A.functions__isolateTypeString$closure(), "isolateTypeBool", A.functions__isolateTypeBool$closure(), "isolateTypeList", A.functions__isolateTypeList$closure(), "isolateTypeMap", A.functions__isolateTypeMap$closure(), "isolateNullableInt", A.functions__isolateNullableInt$closure(), "addFuture", A.functions__addFuture$closure(), "add", A.functions__add$closure(), "addException", A.functions__addException$closure(), "concat", A.functions__concat$closure(), "complexReturn", A.functions__complexReturn$closure()], type$.String, type$.Function));
  })();
