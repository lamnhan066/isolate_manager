...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = type$.int;
      A.IsolateManagerFunction_workerFunction(A.functions__fibonacciFuture$closure(), t1, t1);
    },
    fibonacciFuture(n) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              if (n < 0)
                throw A.wrapException(A.StateError$("n<0"));
              if (n === 0) {
                $async$returnValue = 0;
                // goto return
                $async$goto = 1;
              ...
              for (f1 = 0, f2 = 1, r = 1, i = 2; i <= n; ++i, f1 = f2, f2 = r)
                r = f1 + f2;
              $async$returnValue = r;
              // goto return
              $async$goto = 1;
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "functions__fibonacciFuture$closure", "fibonacciFuture", 28);
  })();
